...
INSERT INTO OEUVRE VALUES(2,1,2,' Echanges',35,2020,'anya taylor-joy, ..',16,'D abord déroutée par sa nouvelle vie en banlieue, la jeune Beth étudie ses camarades de lycée tout en élaborant un plan pour participer à un tournoi d échecs.','séries inspirées de livres, séries us','psychologique, intime, émotion');
INSERT INTO OEUVRE VALUES(7,-1,-1,-1, 125,2010,'leonardo dicaprio, ..' ,13,'Un voleur spécialisé dans l extraction des secrets enfouis dans les rêves accepte une dernière mission dangereuse : semer une idée dans le subconscient d un homme.', 'action, action et fantastique, cyberpunk ..','halluciant, suspence, palpitant');
...
INSERT INTO OEUVRE VALUES(3,1,2,'Le barjot de Marble Street',55,2019,'Winona Ryder, David Harbour, Finn Wolfhard',16,'Lucas, Mike et Dustin tentent de communiquer avec la fille qu ils ont découverte dans les bois. Hopper interroge Joyce à propos d un étrange appel téléphonique','Series SF, Séries pour ados, Thrillers TV','Effrayant, palpitant');
...
INSERT INTO OEUVRE VALUES(8,-1,-1,-1,136,1999,'Keanu Reeves, Laurence Fishburne, Carrie-Anne Moss',16,'Un hacker informatique découvre qu il vit dans un monde virtuel créé par des machines et rejoint un groupe de rebelles pour s en libérer.','Action, SF, fantatisque','Sombre, palpitant');
INSERT INTO OEUVRE VALUES(9,-1,-1,-1,83,1990,'Alex Vincent , Jenny Agutter , Brad Dourif ...',18,'Un fabricant de jouets ressuscite sans le vouloir la pire poupée tueuse de tous les temps, Chucky, qui reprend immédiatement ses activités mortifères.','Horreur , Films d horreur gore , Horreur et surnaturel','Suspense');
